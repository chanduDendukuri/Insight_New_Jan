...
// TODO Auto-generated catch block
	...
	public void createHtmlSummaryReport(String Url, boolean append)
		...
		try {
			...
			writer.write("<th>" + ReporterConstants.BROWSER_NAME + "</th> ");
...
//			e.printStackTrace();
	...
	private void onFailure(String strStepName, String strStepDes,String input,
		...
		try {
			 ...
			 * );
			 */
			// New Screen hjhgjhgshot code to avoid overriding \\\\
			writer.write("<td class='Fail' align='center'><a  href='"
					+ href
					+ "'"
 ...
 */
	...
	public void failureReport(String strStepName, String strStepDes,String input,
		...
		String ran=generateRandomNumberBasedOnLength(1);
		switch (ReporterConstants.REPORT_FORMAT.toLowerCase()) {
			...
			case "html":
				...
				if(file.exists()) {
					 fileName = this.filePath() + File.separatorChar
							+ ReporterConstants.FOLDER_SCREENRSHOTS
							+ File.separatorChar + (strStepDes.replaceAll("<b>","")).replaceAll("</b>","") +ran+ ".jpeg";
				}
