...
public class TestResult {
	...
	public static  Map<BrowserContext,Map<String,Integer>> testPass=new LinkedHashMap<BrowserContext,Map<String, Integer>>();
	...
	public static Map<BrowserContext, Map<String, String>> testData= new LinkedHashMap<BrowserContext, Map<String, String>>();
	...
	public static Map<BrowserContext, String> CounterPas = new LinkedHashMap<BrowserContext, String>();
	...
	public static Map<BrowserContext, String> tc_testdata = new LinkedHashMap<BrowserContext, String>();
	public static Map<BrowserContext, String> packageName = new LinkedHashMap<BrowserContext, String>();
	public static Map<BrowserContext, Map<String, String>> PassNumb = new LinkedHashMap<BrowserContext, Map<String, String>>();
	public static Map<BrowserContext, Map<String, String>> CounterPass = new LinkedHashMap<BrowserContext, Map<String, String>>();
	public static Map<BrowserContext, Map<String, String>> CounterFail = new LinkedHashMap<BrowserContext, Map<String, String>>();
	...
	public static Map<BrowserContext, Map<Integer, Integer>> mapBrowserContextTestCasePassValue = new LinkedHashMap<BrowserContext, Map<Integer, Integer>>();
	public static Map<BrowserContext, Map<String, String>> mapBrowserContextTestCaseFailValue = new LinkedHashMap<BrowserContext, Map<String, String>>();
