...
public class CRT18_SaveCartShipBillPayTest extends CartLib {
	...
	public void Tc_CRT18(int StartRow,String EndRow,boolean nextTestJoin) throws Throwable {
					...
					try {
						...
						for (int intCounter = intStartRow; intCounter <= intEndRow; intCounter++) {
							try {
								...
								Hashtable<String, String> data = TestUtil.getDataByRowNo("CRT18_SaveCartShipBillPay", TestDataInsight,
										"Web_Cart", intCounter);
		...
		//	gErrorMessage = e.toString();
			gTestStatus = false;
			ReportStatus.fnUpdateResultStatus("SaveCartShipBillPay", "Tc_CRT18", ReportStatus.strMethodName, 1, browser);
