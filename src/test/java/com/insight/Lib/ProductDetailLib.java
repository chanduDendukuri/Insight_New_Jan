...
*/
    ...
    public String selectRecommendedProductDetials() throws Throwable {
        String prodName = null;
        List<WebElement> prod = driver.findElements(recommendedPrinters);
        if (prod.size() != 0) {
            for (int i = 0; i < prod.size(); i++) {
                prodName = prod.get(i).getText();
                reporter.SuccessReport("Product Name ", "Selected Product Name is ", prodName);
                prod.get(i).click();
                break;
            }
        }
	...
	/*public String getProductDetails() throws Throwable{
