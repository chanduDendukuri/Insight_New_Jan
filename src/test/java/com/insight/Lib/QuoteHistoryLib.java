...
public class QuoteHistoryLib extends QuoteHistoryObj {
    ...
    public void ClickFirstQuoteNumber() throws Throwable {
        String QN = getText(CMTObj.FirstQuoteNUmberLink, "FirstQuoteNUmberLink");
        click(CMTObj.FirstQuoteNUmberLink, "FirstQuoteNUmberLink", QN);
    ...
    public String verifyDirectClientErrorMessage() throws Throwable {
        String ErrorMessage = getText(DirectClientQUICKSHOP_ERROR_MSG, "Error Msg Present");
        if (isElementPresent(DirectClientQUICKSHOP_ERROR_MSG, "Error Msg Present")) {
            reporter.SuccessReport("Verify quick shop Erorr Message", " quick shop Error Message is present", ErrorMessage);
        } else {

            reporter.failureReport("Verify quick shop Erorr Message", "quick shop Error Message is not present", "", driver);
        }
        return ErrorMessage;
    }
	public boolean verifyDirectClientErrorMessageavailability() throws Throwable {

	return isVisibleOnly(DirectClientQUICKSHOP_ERROR_MSG, "Error Msg Present") ;
