...
public class CQT22_IPSContractpricing_ContractReviewContract extends HomeLib {
	...
	@Parameters({ "StartRow", "EndRow", "nextTestJoin" })
	@Test
	public void TC_CQT22(int StartRow, String EndRow, boolean nextTestJoin) throws Throwable {
		int counter = 0;
		try {
			...
			for (int intCounter = intStartRow; intCounter <= intEndRow; intCounter++) {
				try {
					...
					TestEngineWeb.reporter.initTestCaseDescription("IPSContractpricing_ContractReviewContract");
					...
					enterRepMarginPercentinLineItem("000010", "repMargin",  "10");
					...
					VerifyContractPriceShouldbeEqualToYPOO(price1value, data.get("ContractId"));// ZPFX
																							...
																							// price
					clickDoneButton();
					verifyZPOOequalstheYDLPandZPLS(price2value, price3value, price4value);// ZP=ZMAM+Z0RC
